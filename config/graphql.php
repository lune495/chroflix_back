    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                \App\GraphQL\Query\HistoirePaginatedQuery::class,
                \App\GraphQL\Query\ChapitrePaginatedQuery::class,
                \App\GraphQL\Query\CommandePaginatedQuery::class,
                \App\GraphQL\Query\FamilleHistoirePaginatedQuery::class,
            ...
            'types' => [
                ...
                \App\GraphQL\Type\HistoireType::class,
                \App\GraphQL\Type\ChapitreType::class,
                \App\GraphQL\Type\BibliothequeType::class,
                \App\GraphQL\Type\BibliothequeHistoireType::class,
                \App\GraphQL\Type\CommandeType::class,
                \App\GraphQL\Type\FamilleHistoireType::class,
                \App\GraphQL\Type\UserPaginatedType::class,
                \App\GraphQL\Type\ChapitrePaginatedType::class,
                \App\GraphQL\Type\CommandePaginatedType::class,
                \App\GraphQL\Type\HistoirePaginatedType::class,
                \App\GraphQL\Type\FamilleHistoirePaginatedType::class,
